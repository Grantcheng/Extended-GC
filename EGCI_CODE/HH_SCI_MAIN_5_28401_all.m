...
if ie==1
    ...
    elseif ie==13
    V1=load('HH_28401/Couple=0.22/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_28401/Couple=0.22/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==14
    V1=load('HH_28401/Couple=0.26/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_28401/Couple=0.26/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==15
    V1=load('HH_28401/Couple=0.3/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_28401/Couple=0.3/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==16
    V1=load('HH_28401/Couple=0.34/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_28401/Couple=0.34/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==17
    V1=load('HH_28401/Couple=0.38/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_28401/Couple=0.38/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==18
    V1=load('HH_28401/Couple=0.42/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_28401/Couple=0.42/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==19
    V1=load('HH_28401/Couple=0.46/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_28401/Couple=0.46/HH_Solution_w1_0.28_1.txt');
  
    elseif ie==20
    V1=load('HH_28401/Couple=0.5/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_28401/Couple=0.5/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==21
%     V1=load('HH_28401/Couple=0.54/HH_Solution_w1_0.28_0.txt');
%     V2=load('HH_28401/Couple=0.54/HH_Solution_w1_0.28_1.txt');
     continue;
     
    elseif ie==22
    V1=load('HH_28401/Couple=0.58/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_28401/Couple=0.58/HH_Solution_w1_0.28_1.txt');
       
    elseif ie==23
    V1=load('HH_28401/Couple=0.62/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_28401/Couple=0.62/HH_Solution_w1_0.28_1.txt');
  
    elseif ie==24
    V1=load('HH_28401/Couple=0.66/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_28401/Couple=0.66/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==25
    V1=load('HH_28401/Couple=0.7/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_28401/Couple=0.7/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==26
    V1=load('HH_28401/Couple=0.74/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_28401/Couple=0.74/HH_Solution_w1_0.28_1.txt');

    elseif ie==27
    V1=load('HH_28401/Couple=0.78/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_28401/Couple=0.78/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==28
    V1=load('HH_28401/Couple=0.82/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_28401/Couple=0.82/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==29
    V1=load('HH_28401/Couple=0.86/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_28401/Couple=0.86/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==30
    V1=load('HH_28401/Couple=0.9/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_28401/Couple=0.9/HH_Solution_w1_0.28_1.txt');
   
    elseif ie==31
    V1=load('HH_28401/Couple=0.94/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_28401/Couple=0.94/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==32
    V1=load('HH_28401/Couple=0.98/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_28401/Couple=0.98/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==33
    V1=load('HH_28401/Couple=1/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_28401/Couple=1/HH_Solution_w1_0.28_1.txt');
...
max_k=length(x);
if  SNR_Determined==1
sigma_white=sqrt(var(y))/10^(3.604264641226475)
end
...
Resultsmat=[pwd,'/',str_name];
 ...
 elseif data_chose==28401
     if Noise_Add==1
      str_name=(['HH_28401/F_Test/Noise_Results/mx_',num2str(mx),' my_',num2str(my),'Sigma_',num2str(sigma_white),' Results mat']);    
     else
