...
epstot=[0 0.1 0.11 0.12 0.13 0.14 0.15 0.16 0.17 0.18 0.19 0.2 0.21];
time=0;
Realization=1;
% mx_vect=[7 8 9 10];
% my_vect=[1 2 3 4 5 6];
...
if ie==1
    ...
    elseif ie==13
    V1=load('HH_28253/Couple=0.21/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_28253/Couple=0.21/HH_Solution_w1_0.28_1.txt');
end
     elseif data_chose==6
...
global Resultsmat;
if data_chose==28253 
    str_name=(['HH_28253/mx_',num2str(mx),' my_',num2str(my),' Results mat']);
if ~exist(str_name)
    mkdir(str_name)
end
...
if data_chose==28253 
      fid=fopen('HH_28253/HH_28253_EGCI_Results.txt','a+');
