...
if data_chose==280
     if Noise_Add==1
         ...
         str_name_1=(['HH_Three_280/Noise_Results_All/SNR_X=',num2str(x_sigma),' SNR_Y=',num2str(y_sigma),' SNR_Z=',num2str(y_sigma),'_']);  
     else
...
if data_chose==280
    if Noise_Add==1
%      fid=fopen('HH_Three_280/HH_Three_280_EGCI_Noise_Results_xy.txt','a+');
%      fid_xz=fopen('HH_Three_280/HH_Three_280_EGCI_Noise_Results_xz.txt','a+');
%      fid_yz=fopen('HH_Three_280/HH_Three_280_EGCI_Noise_Results_yz.txt','a+');
