...
if ie==1
   ...
   elseif ie==2
    V1=load('HH_280/Couple=0.02/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_280/Couple=0.02/HH_Solution_w1_0.28_1.txt');   
    
    elseif ie==3
    V1=load('HH_280/Couple=0.04/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_280/Couple=0.04/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==4
    V1=load('HH_280/Couple=0.06/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_280/Couple=0.06/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==5
    V1=load('HH_280/Couple=0.08/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_280/Couple=0.08/HH_Solution_w1_0.28_1.txt');
...
Resultsmat=[pwd,'/',str_name];
 ...
 elseif data_chose==280
     if Noise_Add==1
         str_name=(['HH_280/F_Test/Noise_Results_All/mx_',num2str(mx),' my_',num2str(my),'Sigma_',num2str(sigma_white),' Results mat']);    
     else
 str_name=(['HH_280/F_Test/mx_',num2str(mx),' my_',num2str(my),' Results mat']);
     end
if ~exist(str_name)
    mkdir(str_name)
end
...
if data_chose==3766 
 ...
 elseif data_chose==280
     fid=fopen('HH_280/HH_280_EGCI_Noise_Results.txt','a+');
