...
if ie==1
   ...
   elseif ie==2
    ...
    elseif ie==4
    V1=load('HH_28401/Couple=0.0.6/HH_Solution_w1_0.28_0.txt');
...
c1 = cao(s1,14,taux,3,1000);c2 = cao(s2,14,taux,3,1000);
...
Resultsmat=[pwd,'/',str_name];
 ...
 elseif data_chose==28401
      ...
      str_name=(['HH_28401/F_Test/Noise_Results_All/mx_',num2str(mx),' my_',num2str(my),'System_Results mat']);    
