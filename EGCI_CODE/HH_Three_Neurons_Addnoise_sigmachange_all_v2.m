% CEGCI for f1=0.28 f2=0.28 f3=0.28 Amp1=Amp2=10
clc
clear
% close all
tic;
...
for ie=ie_3:Leng_IE
   ...
   if ie==1
    V1=load('HH_Three_280/Couple=0/Solution/Three_HH_Solution0w1_0.28w2_0.282w3_0.29.txt');
    V2=load('HH_Three_280/Couple=0/Solution/Three_HH_Solution1w1_0.28w2_0.282w3_0.29.txt');
    V3=load('HH_Three_280/Couple=0/Solution/Three_HH_Solution2w1_0.28w2_0.282w3_0.29.txt');
    eigvalue=load('HH_Three_280/Couple=0/eig_21_10000000.txt');
    
   elseif ie==2
    V1=load('HH_Three_280/Couple=0.02/Solution/Three_HH_Solution0w1_0.28w2_0.282w3_0.29.txt');
    V2=load('HH_Three_280/Couple=0.02/Solution/Three_HH_Solution1w1_0.28w2_0.282w3_0.29.txt');
    V3=load('HH_Three_280/Couple=0.02/Solution/Three_HH_Solution2w1_0.28w2_0.282w3_0.29.txt');
    eigvalue=load('HH_Three_280/Couple=0.02/eig_21_10000000.txt');
    
    elseif ie==3
    V1=load('HH_Three_280/Couple=0.04/Solution/Three_HH_Solution0w1_0.28w2_0.282w3_0.29.txt');
    V2=load('HH_Three_280/Couple=0.04/Solution/Three_HH_Solution1w1_0.28w2_0.282w3_0.29.txt');
    V3=load('HH_Three_280/Couple=0.04/Solution/Three_HH_Solution2w1_0.28w2_0.282w3_0.29.txt');
    eigvalue=load('HH_Three_280/Couple=0.04/eig_21_10000000.txt');
    
    elseif ie==4
    V1=load('HH_Three_280/Couple=0.06/Solution/Three_HH_Solution0w1_0.28w2_0.282w3_0.29.txt');
    V2=load('HH_Three_280/Couple=0.06/Solution/Three_HH_Solution1w1_0.28w2_0.282w3_0.29.txt');
    V3=load('HH_Three_280/Couple=0.06/Solution/Three_HH_Solution2w1_0.28w2_0.282w3_0.29.txt');
    eigvalue=load('HH_Three_280/Couple=0.06/eig_21_10000000.txt');
    
    elseif ie==5
    V1=load('HH_Three_280/Couple=0.08/Solution/Three_HH_Solution0w1_0.28w2_0.282w3_0.29.txt');
    V2=load('HH_Three_280/Couple=0.08/Solution/Three_HH_Solution1w1_0.28w2_0.282w3_0.29.txt');
    V3=load('HH_Three_280/Couple=0.08/Solution/Three_HH_Solution2w1_0.28w2_0.282w3_0.29.txt');
    eigvalue=load('HH_Three_280/Couple=0.08/eig_21_10000000.txt');
    
    elseif ie==6
    V1=load('HH_Three_280/Couple=0.1/Solution/Three_HH_Solution0w1_0.28w2_0.282w3_0.29.txt');
    V2=load('HH_Three_280/Couple=0.1/Solution/Three_HH_Solution1w1_0.28w2_0.282w3_0.29.txt');
    V3=load('HH_Three_280/Couple=0.1/Solution/Three_HH_Solution2w1_0.28w2_0.282w3_0.29.txt');
    eigvalue=load('HH_Three_280/Couple=0.1/eig_21_10000000.txt');
     
    elseif ie==7
    V1=load('HH_Three_280/Couple=0.11/Solution/Three_HH_Solution0w1_0.28w2_0.282w3_0.29.txt');
    V2=load('HH_Three_280/Couple=0.11/Solution/Three_HH_Solution1w1_0.28w2_0.282w3_0.29.txt');
    V3=load('HH_Three_280/Couple=0.11/Solution/Three_HH_Solution2w1_0.28w2_0.282w3_0.29.txt');
    eigvalue=load('HH_Three_280/Couple=0.11/eig_21_10000000.txt');
     
    elseif ie==8
    V1=load('HH_Three_280/Couple=0.12/Solution/Three_HH_Solution0w1_0.28w2_0.282w3_0.29.txt');
    V2=load('HH_Three_280/Couple=0.12/Solution/Three_HH_Solution1w1_0.28w2_0.282w3_0.29.txt');
    V3=load('HH_Three_280/Couple=0.12/Solution/Three_HH_Solution2w1_0.28w2_0.282w3_0.29.txt');
    eigvalue=load('HH_Three_280/Couple=0.12/eig_21_10000000.txt');
        
    elseif ie==9
    V1=load('HH_Three_280/Couple=0.13/Solution/Three_HH_Solution0w1_0.28w2_0.282w3_0.29.txt');
    V2=load('HH_Three_280/Couple=0.13/Solution/Three_HH_Solution1w1_0.28w2_0.282w3_0.29.txt');
    V3=load('HH_Three_280/Couple=0.13/Solution/Three_HH_Solution2w1_0.28w2_0.282w3_0.29.txt');
    eigvalue=load('HH_Three_280/Couple=0.13/eig_21_10000000.txt');
    
    elseif ie==10
    V1=load('HH_Three_280/Couple=0.14/Solution/Three_HH_Solution0w1_0.28w2_0.282w3_0.29.txt');
    V2=load('HH_Three_280/Couple=0.14/Solution/Three_HH_Solution1w1_0.28w2_0.282w3_0.29.txt');
    V3=load('HH_Three_280/Couple=0.14/Solution/Three_HH_Solution2w1_0.28w2_0.282w3_0.29.txt');
    eigvalue=load('HH_Three_280/Couple=0.14/eig_21_10000000.txt');
        
    elseif ie==11
    V1=load('HH_Three_280/Couple=0.15/Solution/Three_HH_Solution0w1_0.28w2_0.282w3_0.29.txt');
    V2=load('HH_Three_280/Couple=0.15/Solution/Three_HH_Solution1w1_0.28w2_0.282w3_0.29.txt');
    V3=load('HH_Three_280/Couple=0.15/Solution/Three_HH_Solution2w1_0.28w2_0.282w3_0.29.txt');
    eigvalue=load('HH_Three_280/Couple=0.15/eig_21_10000000.txt');
     
    elseif ie==12
    V1=load('HH_Three_280/Couple=0.16/Solution/Three_HH_Solution0w1_0.28w2_0.282w3_0.29.txt');
    V2=load('HH_Three_280/Couple=0.16/Solution/Three_HH_Solution1w1_0.28w2_0.282w3_0.29.txt');
    V3=load('HH_Three_280/Couple=0.16/Solution/Three_HH_Solution2w1_0.28w2_0.282w3_0.29.txt');
...
if data_chose==280
     if Noise_Add==1
         ...
         if Noise_Type_Choose==1
         str_name_1=(['HH_Three_280/Noise_Results_All/SNR_X=',num2str(x_sigma),' SNR_Y=',num2str(y_sigma),' SNR_Z=',num2str(z_sigma),'_']);  
         elseif Noise_Type_Choose==2
         str_name_1=(['HH_Three_280/Noise_Results_All/Noise_X=',num2str(sigma_white),' Noise_Y=',num2str(sigma_white_Noise1),' Noise_Z=',num2str(sigma_white_Noise1),'_']); 
         end
         else
         str_name=(['HH_Three_280/Noise_Results_All/mx_',num2str(mx),' my_',num2str(my),' mz_',num2str(mz),'Sigma_',num2str(sigma_white),' Results mat']);  
         if Noise_Type_Choose==1
         str_name_1=(['HH_Three_280/Noise_Results_All/SNR_X=',num2str(x_sigma),' SNR_Y=',num2str(y_sigma),' SNR_Z=',num2str(z_sigma),'Difftau_']);  
         elseif Noise_Type_Choose==2
         str_name_1=(['HH_Three_280/Noise_Results_All/Noise_X=',num2str(sigma_white),' Noise_Y=',num2str(sigma_white_Noise1),' Noise_Z=',num2str(sigma_white_Noise1),'Difftau_']); 
         end
         end
     else
