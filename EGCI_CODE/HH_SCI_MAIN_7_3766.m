...
if ie==1
    ...
    elseif ie==13
    V1=load('HH_3766/Couple=0.24/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_3766/Couple=0.24/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==14
    V1=load('HH_3766/Couple=0.28/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_3766/Couple=0.28/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==15
    V1=load('HH_3766/Couple=0.32/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_3766/Couple=0.32/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==16
    V1=load('HH_3766/Couple=0.36/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_3766/Couple=0.36/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==17
    V1=load('HH_3766/Couple=0.4/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_3766/Couple=0.4/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==18
    V1=load('HH_3766/Couple=0.44/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_3766/Couple=0.44/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==19
    V1=load('HH_3766/Couple=0.48/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_3766/Couple=0.48/HH_Solution_w1_0.28_1.txt');
  
    elseif ie==20
    V1=load('HH_3766/Couple=0.52/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_3766/Couple=0.52/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==21
    V1=load('HH_3766/Couple=0.56/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_3766/Couple=0.56/HH_Solution_w1_0.28_1.txt');
       
    elseif ie==22
    V1=load('HH_3766/Couple=0.6/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_3766/Couple=0.6/HH_Solution_w1_0.28_1.txt');
  
    elseif ie==23
    V1=load('HH_3766/Couple=0.64/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_3766/Couple=0.64/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==24
    V1=load('HH_3766/Couple=0.68/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_3766/Couple=0.68/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==25
    V1=load('HH_3766/Couple=0.72/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_3766/Couple=0.72/HH_Solution_w1_0.28_1.txt');

    elseif ie==26
    V1=load('HH_3766/Couple=0.76/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_3766/Couple=0.76/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==27
    V1=load('HH_3766/Couple=0.8/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_3766/Couple=0.8/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==28
    V1=load('HH_3766/Couple=0.84/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_3766/Couple=0.84/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==29
    V1=load('HH_3766/Couple=0.88/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_3766/Couple=0.88/HH_Solution_w1_0.28_1.txt');
   
    elseif ie==30
    V1=load('HH_3766/Couple=0.92/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_3766/Couple=0.92/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==31
    V1=load('HH_3766/Couple=0.96/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_3766/Couple=0.96/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==32
    V1=load('HH_3766/Couple=1/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_3766/Couple=1/HH_Solution_w1_0.28_1.txt');
