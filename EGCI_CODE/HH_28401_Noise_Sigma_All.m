...
epstot=epstot_1
Sigma_Noise=[0.00005 0.0001 0.0005 0.001 0.005 0.01 0.05 0.1]
time=0;
GC_Matrix=zeros(1,2);
data_chose=28401;
...
sigma_white=sqrt(var(y))/10^(3.604264641226475)
    ...
    sigma_white=Sigma_Noise(sigma_i);
end
...
Var_xy(sigma_i,1:Realization)=Var;%
Var_yx(sigma_i,1:Realization)=RSS;%
MX(sigma_i)=mx;
MY(sigma_i)=my;
Tau(sigma_i)=taux;
end
