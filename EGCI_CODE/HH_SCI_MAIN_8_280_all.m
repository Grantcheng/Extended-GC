% EGCI for f1=0.28 f2=0 S12=change S21=0 Amp1=Amp2=10
clc
clear
% close all
tic;
display('The HH_280 All Couple Program ......   ');
...
DetalN=1;
M=input('The neighborhood size is = ');   
end
...
X=[V1(1,1:stv_L:length_N);V2(1,1:stv_L:length_N)];
    ...
    V1=load('HH_3766/Couple=0.17/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_3766/Couple=0.17/HH_Solution_w1_0.28_1.txt');
     elseif data_chose==280
if ie==1
    V1=load('HH_280/Couple=0/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_280/Couple=0/HH_Solution_w1_0.28_1.txt');
      
    elseif ie==2
    V1=load('HH_280/Couple=0.1/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_280/Couple=0.1/HH_Solution_w1_0.28_1.txt');
     
    elseif ie==3
     V1=load('HH_280/Couple=0.11/HH_Solution_w1_0.28_0.txt');
     V2=load('HH_280/Couple=0.11/HH_Solution_w1_0.28_1.txt');
     
    elseif ie==4
    V1=load('HH_280/Couple=0.12/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_280/Couple=0.12/HH_Solution_w1_0.28_1.txt');
        
    elseif ie==5
    V1=load('HH_280/Couple=0.13/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_280/Couple=0.13/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==6
    V1=load('HH_280/Couple=0.14/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_280/Couple=0.14/HH_Solution_w1_0.28_1.txt');
        
    elseif ie==7
    V1=load('HH_280/Couple=0.15/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_280/Couple=0.15/HH_Solution_w1_0.28_1.txt');
     
    elseif ie==8
    V1=load('HH_280/Couple=0.16/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_280/Couple=0.16/HH_Solution_w1_0.28_1.txt');
       
    elseif ie==9
    V1=load('HH_280/Couple=0.17/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_280/Couple=0.17/HH_Solution_w1_0.28_1.txt');
        
    elseif ie==10
    V1=load('HH_280/Couple=0.18/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_280/Couple=0.18/HH_Solution_w1_0.28_1.txt');
            
    elseif ie==11
    V1=load('HH_280/Couple=0.19/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_280/Couple=0.19/HH_Solution_w1_0.28_1.txt');
     
    elseif  ie==12
    V1=load('HH_280/Couple=0.2/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_280/Couple=0.2/HH_Solution_w1_0.28_1.txt');
          
    elseif ie==13
    V1=load('HH_280/Couple=0.24/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_280/Couple=0.24/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==14
    V1=load('HH_280/Couple=0.28/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_280/Couple=0.28/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==15
    V1=load('HH_280/Couple=0.32/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_280/Couple=0.32/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==16
    V1=load('HH_280/Couple=0.36/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_280/Couple=0.36/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==17
    V1=load('HH_280/Couple=0.4/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_280/Couple=0.4/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==18
    V1=load('HH_280/Couple=0.44/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_280/Couple=0.44/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==19
    V1=load('HH_280/Couple=0.48/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_280/Couple=0.48/HH_Solution_w1_0.28_1.txt');
  
    elseif ie==20
    V1=load('HH_280/Couple=0.52/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_280/Couple=0.52/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==21
    V1=load('HH_280/Couple=0.56/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_280/Couple=0.56/HH_Solution_w1_0.28_1.txt');
       
    elseif ie==22
    V1=load('HH_280/Couple=0.6/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_280/Couple=0.6/HH_Solution_w1_0.28_1.txt');
  
    elseif ie==23
    V1=load('HH_280/Couple=0.64/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_280/Couple=0.64/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==24
    V1=load('HH_280/Couple=0.68/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_280/Couple=0.68/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==25
    V1=load('HH_280/Couple=0.72/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_280/Couple=0.72/HH_Solution_w1_0.28_1.txt');

    elseif ie==26
    V1=load('HH_280/Couple=0.76/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_280/Couple=0.76/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==27
    V1=load('HH_280/Couple=0.8/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_280/Couple=0.8/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==28
    V1=load('HH_280/Couple=0.84/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_280/Couple=0.84/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==29
    V1=load('HH_280/Couple=0.88/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_280/Couple=0.88/HH_Solution_w1_0.28_1.txt');
   
    elseif ie==30
    V1=load('HH_280/Couple=0.92/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_280/Couple=0.92/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==31
    V1=load('HH_280/Couple=0.96/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_280/Couple=0.96/HH_Solution_w1_0.28_1.txt');
    
    elseif ie==32
    V1=load('HH_280/Couple=1/HH_Solution_w1_0.28_0.txt');
    V2=load('HH_280/Couple=1/HH_Solution_w1_0.28_1.txt');
...
Resultsmat=[pwd,'/',str_name];
 ...
 elseif data_chose==280
 str_name=(['HH_280/mx_',num2str(mx),' my_',num2str(my),' Results mat']);
if ~exist(str_name)
    mkdir(str_name)
end
Resultsmat=[pwd,'/',str_name];
